...
Icon styles: quote(") icon, twitter icon = #tweet-quote (font awesome)
...
1. React Component:
-Class; this-state (React.useState, more comprehensive, usually sufficient for non-complex apps)
-Methods
-Render

2. Redux:
-Action
-Action Creator ; quoteBox, colors
-Reducer ; QuoteBox
-Store ; 

3. React-Redux:
-Provider; wrapper component, rendered. ; ReactDOM.render
-Connect; mapStateToProps(), mapDispatchToProps() (??)

CSS:
-Transitions
-Background color is #text color is buttons color but #quote-box consistently remains #fff (partly achieved.) 
*/